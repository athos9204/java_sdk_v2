...
@PropertySource("file:./mobile-connect-example-authentication/src/main/resources/config/mobile-connect-config.properties")
public class AuthenticationExampleAppConfiguration
{
    @Bean
