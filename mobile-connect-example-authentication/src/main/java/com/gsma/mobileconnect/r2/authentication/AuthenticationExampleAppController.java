...
public class AuthenticationExampleAppController
{
    private static final Logger LOGGER = LoggerFactory.getLogger(AuthenticationExampleAppController.class);

    private final MobileConnectWebInterface mobileConnectWebInterface;

    public AuthenticationExampleAppController(@Autowired final MobileConnectWebInterface mobileConnectWebInterface)
    {
