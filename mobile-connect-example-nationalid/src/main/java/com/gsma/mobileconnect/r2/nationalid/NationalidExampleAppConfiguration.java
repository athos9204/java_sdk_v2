...
@PropertySource("file:./mobile-connect-example-nationalid/src/main/resources/config/mobile-connect-config.properties")
public class NationalidExampleAppConfiguration
{
    @Bean
