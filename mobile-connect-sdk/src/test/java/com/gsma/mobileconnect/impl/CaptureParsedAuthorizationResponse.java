...
public class CaptureParsedAuthorizationResponse
    implements IParseAuthenticationResponseCallback
{
    ...
    public void complete(ParsedAuthorizationResponse parsedAuthorizationResponse)
    {
        this.parsedAuthorizationResponse = parsedAuthorizationResponse;
    }
}
