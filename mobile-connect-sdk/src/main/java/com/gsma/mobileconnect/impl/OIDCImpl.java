...
class OIDCImpl implements IOIDC
{
    ...
    OIDCImpl(RestClient restClient)
    {
        ...
        throws OIDCException, DiscoveryResponseExpiredException
    {
        ...
        ParsedOperatorIdentifiedDiscoveryResult parsedOperatorIdentifiedDiscoveryResult = JsonUtils.parseOperatorIdentifiedDiscoveryResult(discoveryResult.getResponseData());
     ...
     */
    public void parseAuthenticationResponse(String redirectURL, IParseAuthenticationResponseCallback callback)
            throws OIDCException
    {
        validateParseAuthenticationResponseParameters(redirectURL, callback);

        List<NameValuePair> nameValuePairs = getParameters(redirectURL);
            ...
            throws OIDCException, DiscoveryResponseExpiredException
    {
        ...
        try
        {
            ...
            RequestTokenResponse requestTokenResponse = JsonUtils.parseRequestTokenResponse(Calendar.getInstance(), restResponse.getResponse());
            ...
            throws OIDCException, DiscoveryResponseExpiredException
    {
        ...
        try
        {
            ParsedIdToken parsedIdToken = JsonUtils.createParsedIdToken(id_tokenStr);
