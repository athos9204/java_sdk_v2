...
public class CaptureRequestTokenResponse implements IRequestTokenCallback
{
    ...
    public void complete(RequestTokenResponse newRequestTokenResponse)
    {
       requestTokenResponse = newRequestTokenResponse;
    }
}
