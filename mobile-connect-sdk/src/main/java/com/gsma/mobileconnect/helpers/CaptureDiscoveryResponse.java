...
public class CaptureDiscoveryResponse implements IDiscoveryResponseCallback
{
    ...
    public void completed(DiscoveryResponse newDiscoveryResponse)
    {
        this.discoveryResponse = newDiscoveryResponse;
    }
}
