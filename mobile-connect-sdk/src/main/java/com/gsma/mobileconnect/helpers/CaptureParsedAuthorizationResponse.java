...
public class CaptureParsedAuthorizationResponse implements IParseAuthenticationResponseCallback
{
    ...
    public void complete(ParsedAuthorizationResponse newParsedAuthorizationResponse)
    {
        parsedAuthorizationResponse = newParsedAuthorizationResponse;
    }
}
