 ...
 */
package com.gsma.mobileconnect.r2.signup;
...
public class SignupExampleAppController
{
    private static final Logger LOGGER = LoggerFactory.getLogger(SignupExampleAppController.class);

    private final MobileConnectWebInterface mobileConnectWebInterface;

    public SignupExampleAppController(@Autowired final MobileConnectWebInterface mobileConnectWebInterface)
    {
    ...
    {
        final String scope = "mc_authz mc_identity_signup";
