...
@PropertySource("file:./mobile-connect-example-phonenumber/src/main/resources/config/mobile-connect-config.properties")
public class PhonenumberExampleAppConfiguration
{
    @Bean
