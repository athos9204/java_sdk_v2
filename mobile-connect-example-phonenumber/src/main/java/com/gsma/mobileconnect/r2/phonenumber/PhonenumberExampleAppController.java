 ...
 */
package com.gsma.mobileconnect.r2.phonenumber;
...
public class PhonenumberExampleAppController
{
    private static final Logger LOGGER = LoggerFactory.getLogger(PhonenumberExampleAppController.class);

    private final MobileConnectWebInterface mobileConnectWebInterface;

    public PhonenumberExampleAppController(@Autowired final MobileConnectWebInterface mobileConnectWebInterface)
    {
    ...
    {
        final String scope = "mc_authz mc_identity_phonenumber";
